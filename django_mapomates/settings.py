# Django settings for django_mapomates project.
import logging
import os
import sys
...
SECRET_KEY = '2o(-+54v(rdtavorm2v&%q)-rsi_9x@9)p9l-d!jk#o%-sm_l5'
...
BASE_MIDDLEWARE_CLASSES = [
    ...
    #'django_odesk.middleware.RequestClientMiddleware',
...
ROOT_URLCONF = 'django_mapomates.urls'
...
try:
    ...
    logging.error('Could not import local_settings')
    sys.exit(1)
